...
# HLTC-27 — Actualizar título del PR
...
# HLTC-28 — Actualizar cuerpo del PR
...
def test_hltc31_should_fail_to_add_empty_label_list(pr_api):
    ...
    logger.info("Verificando que el mensaje indica un error de validación")
...
#  Obtener PR existente (integridad)
...
# Acceso no autorizado al PR (token inválido)
...
#  Validar integridad: sin residuos tras tests de actualización
